...
public class OverlayPolyline {
    ...
    private void zoomPath(Path path, Path drawPath, Matrix matrix, float scaleFactor) {
        ...
        translateMatrix.postRotate((float) (360.0 - rotation), projectionHelper.point.x, projectionHelper.point.y);
        ...
        U.log("DebugZoom", "Before - " + rectF.toShortString());
//        matrixTemp.postRotate((float) (360.0 - rotation), projectionHelper.point.x, projectionHelper.point.y);
        ...
        translateMatrix.postRotate((float) (0.0 + rotation), projectionHelper.point.x, projectionHelper.point.y);
        matrix.postConcat(translateMatrix);
        drawPath.rewind();
        drawPath.addPath(path);
        drawPath.transform(matrix);
        U.log("DebugZoom", "After - " + rectF.toShortString());
    ...
    void translatePathMatrix(float dx, float dy, float cameraBearing, Point centerPoint) {
        ...
        rotation = rotation + cameraBearing;
        U.log("Camera rotation" + rotation);
    ...
    private void translatePath(Path path, Path drawPath, Matrix matrix, float dx, float dy, float cameraBearing, Point centerPoint) {
        ...
        drawPath.addPath(path);
        drawPath.transform(matrix);
        U.log("DEBUUUGG", rectF.centerX() + " , " + rectF.centerY());
    }
