    ...
    public void onMapReady(GoogleMap map) {
        ...
        mMap.setOnMapLoadedCallback(new GoogleMap.OnMapLoadedCallback() {
            ...
            public void onMapLoaded() {
                ...
                CameraUpdate cu = CameraUpdateFactory.newLatLngBounds(bounds, screen.getWidth(), screen.getHeight() / 2, 0);
                CameraUpdate scroll = CameraUpdateFactory.scrollBy(0, screen.getHeight() / 4);

                mMap.moveCamera(cu);
                map.animateCamera(scroll);
